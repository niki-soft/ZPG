...
TexturedModel::TexturedModel(std::vector<float> pnts) : Model(pnts){
...
void TexturedModel::initialize()
{
    ...
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, number * sizeof(GL_FLOAT), (GLvoid*)(6 * sizeof(GL_FLOAT)));
